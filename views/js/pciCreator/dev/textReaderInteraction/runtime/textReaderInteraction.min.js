...
var $content,contentHtml,$target=$(this),contentId=$target.attr("aria-describedBy"),qtipPositionTarget="event";if(contentId&&($content=$container.find("#"+contentId),$content.length)){parseInt($($target.get(0)).css("height"),10)/parseInt($($target.get(0)).css("fontSize"),10)>=2&&(qtipPositionTarget="mouse"),contentHtml=$content.html(),$target.qtip({overwrite:!0,theme:"default",content:{text:contentHtml},position:{target:qtipPositionTarget,my:"bottom center",at:"top center"}})}})}}}),
define("taoQtiItem/portableLib/OAT/util/html",["taoQtiItem/portableLib/OAT/util/xml","taoQtiItem/portableLib/OAT/util/math","taoQtiItem/portableLib/OAT/util/tooltip"],function(xml,math,tooltip){"use strict";return{render:function($container){var markup=$container.html();markup=xml.removeNamespace(markup),$container.html(markup),math.render($container),tooltip.render($container)}}}),
define("textReaderInteraction/runtime/js/renderer",["taoQtiItem/portableLib/jquery_2_1_1","taoQtiItem/portableLib/lodash","taoQtiItem/portableLib/handlebars","textReaderInteraction/runtime/js/tabs","taoQtiItem/portableLib/OAT/util/html","taoQtiItem/portableLib/jquery.qtip"],function($,_,Handlebars,Tabs,htmlRenderer){"use strict";var fixMarkupMediaSources=function(html,renderer){return html=html||"",html.replace(/(<img[^>]*src=["'])([^"']+)(["'])/gi,function(substr,$1,$2,$3){return $1+(renderer.resolveUrl($2)||$2)+$3})};return window.jQuery=$,function(options){function getHeight(element){
